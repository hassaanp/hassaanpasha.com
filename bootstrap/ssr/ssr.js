...
function Post({ post }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { title: post.title, children: [
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:site", content: "@hassaan_pasha" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:creator", content: "@hassaan_pasha" }),
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:site_name", content: "Hassaan's Blog" }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: `${window.location.href}` })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsx("div", { className: "pt-16", children: /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsx("div", { className: "px-4", children: /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-4 sm:px-0", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold leading-7 text-gray-900", children: post.title }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 max-w-2xl text-sm leading-6 text-gray-500", children: [
            "👋 ",
            post.description
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "pt-12 px-4 pb-24", children: /* @__PURE__ */ jsx(
        "div",
        {
...
function Welcome({ blog }) {
  console.log(blog);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Hello" }),
    /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "pt-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-4 sm:px-0", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold leading-7 text-gray-900", children: "Hello, World!" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 max-w-2xl text-sm leading-6 text-gray-500", children: "👋 Hey, welcome to my website!" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-6 border-t border-gray-100", children: /* @__PURE__ */ jsxs("dl", { className: "divide-y divide-gray-100", children: [
        /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0", children: [
          /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium leading-6 text-gray-900", children: "About Me" }),
          /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0", children: "I am a software developer and a remote developer advocate. I co-run a few companies and I am always building more. I tinker around with server side development, DevOps, AI/ML, and web development. I also love OSS and have regularly contributed to NodeJS and Freecodecamp. I live on the web, so don't be shy and reach out to me on Twitter or LinkedIn." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0", children: [
          /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium leading-6 text-gray-900", children: "Blog" }),
          /* @__PURE__ */ jsx("dd", { className: "mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0", children: /* @__PURE__ */ jsx(
            "ul",
            {
              role: "list",
              className: "divide-y divide-gray-100 rounded-md border border-gray-200",
              children: blog.map((post) => /* @__PURE__ */ jsxs("li", { className: "flex flex-col md:flex-row items-start md:items-center justify-between py-4 pl-4 pr-5 text-sm leading-6", children: [
                /* @__PURE__ */ jsx("div", { className: "flex w-full md:w-0 flex-1 items-center mb-2 md:mb-0", children: /* @__PURE__ */ jsxs("div", { className: "ml-4 flex flex-col min-w-0 flex-1 gap-2", children: [
                  /* @__PURE__ */ jsx(
                    Link,
                    {
                      href: `/blog/${post.slug}`,
                  ...
                  /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 text-gray-400", children: post.description })
                ] }) }),
                /* @__PURE__ */ jsx("div", { className: "ml-4 flex-shrink-0", children: /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 text-gray-400", children: dayjs(
                  post.date
                ).fromNow() }) })
              ] }))
            }
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.jsx": __vite_glob_0_0, "./Pages/Auth/ForgotPassword.jsx": __vite_glob_0_1, "./Pages/Auth/Login.jsx": __vite_glob_0_2, "./Pages/Auth/Register.jsx": __vite_glob_0_3, "./Pages/Auth/ResetPassword.jsx": __vite_glob_0_4, "./Pages/Auth/VerifyEmail.jsx": __vite_glob_0_5, "./Pages/Blog/Post.jsx": __vite_glob_0_6, "./Pages/Dashboard.jsx": __vite_glob_0_7, "./Pages/Profile/Edit.jsx": __vite_glob_0_8, "./Pages/Profile/Partials/DeleteUserForm.jsx": __vite_glob_0_9, "./Pages/Profile/Partials/UpdatePasswordForm.jsx": __vite_glob_0_10, "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": __vite_glob_0_11, "./Pages/Welcome.jsx": __vite_glob_0_12 });
